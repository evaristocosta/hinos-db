update hino set numero = 0, categoria_id = 7 where nome = 'AQUILO QUE FUI NÃO SOU MAIS' and coletanea_id = 1;
...
update hino set nome = 'AS PARÁBOLAS DO REINO', numero = 4, nome_pt = 'AS PARÁBOLAS DO REINO' where numero = 4 and coletanea_id = 3;
